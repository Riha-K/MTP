...
> **Whole-project plan:** [`../ROADMAP.md`](../ROADMAP.md) (Pillar A CNN validation next)  
> **VLM plan archive:** [`ROADMAP_VLM.md`](ROADMAP_VLM.md)  
> **History:** [`../log.md`](../log.md)  
> **Status:** v0.1 **DONE** (post-fix: ZS **0.052** · FT **0.812** · MultiSenNA **0.679**)
...
| **`lulcdial/README.md`** | Data-prep + short commands |
| **`src/shell/data/Stage4_LULCDial_S1.json`** | Fine-tune shard paths (p25) |
